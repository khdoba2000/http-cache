# http-cache
[![Build Status](https://travis-ci.org/khdoba2000/http-cache.svg?branch=master)](https://travis-ci.org/khdoba2000/http-cache) [![Coverage Status](https://coveralls.io/repos/github/khdoba2000/http-cache/badge.svg?branch=master)](https://coveralls.io/github/khdoba2000/http-cache?branch=master) [![](https://img.shields.io/badge/godoc-reference-5272B4.svg?style=flat)](https://godoc.org/github.com/khdoba2000/http-cache)
...
### Installation
`go get github.com/khdoba2000/http-cache`
...
import (
    ...
    "github.com/khdoba2000/http-cache"
    "github.com/khdoba2000/http-cache/adapter/memory"
)
...
import (
    "github.com/khdoba2000/http-cache"
    "github.com/khdoba2000/http-cache/adapter/redis"
)
...
## Godoc Reference
- [http-cache](https://godoc.org/github.com/khdoba2000/http-cache)
- [Memory adapter](https://godoc.org/github.com/khdoba2000/http-cache/adapter/memory)
- [Redis adapter](https://godoc.org/github.com/khdoba2000/http-cache/adapter/redis)

## License
http-cache is released under the [MIT License](https://github.com/khdoba2000/http-cache/blob/master/LICENSE).
